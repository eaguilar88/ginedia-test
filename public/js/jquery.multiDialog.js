...
function MultiDialog(){
	this.defaults = {
		...
		loadingHandler: function( data ){
			this.isLoading = true;
			this._defaultHandler( "<div class='ui-state-highlight ui-corner-all'><p><span class='ui-icon ui-icon-info'></span><strong>Cargando el contenido, por favor espere</strong></p></div>", "Cargando...", data );
		},

		// error handler
		errorHandler: function( data ){
			this._defaultHandler( "<div class='ui-state-error ui-corner-all'><p><span class='ui-icon ui-icon-alert'></span><strong>Lo sentimos, un error a ocurrido. Intente de nuevo.</strong></p></div>", "Error!", data.data );
		},
